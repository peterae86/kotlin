...
private fun PsiFile.commitAndUnblockDocument(): Boolean {
...
fun KtElement.adjustLineIndent() {
    containingKtFile.adjustLineIndent(textRange.startOffset, textRange.endOffset)
}
